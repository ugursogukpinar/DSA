...
int main(){
	...
	int satirsayisi, sutunsayisi,i,j,matris[31][31],k,temp,bagintimatrisi[31][31],a=0,deger,b,bulunan,secim,dugumlermatrisi[100][3],s=0,renk=0;
