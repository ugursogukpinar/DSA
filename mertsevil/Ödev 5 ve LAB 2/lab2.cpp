...
int main(){
	...
	Mesajdizisi[1]=1;      // 0 ve 1 ile kodlanmis dizinin olusturulmasi
	Mesajdizisi[2]=0;
	...
	Mesajdizisi[9]=0;     // 0 ve 1 ile kodlanmis dizinin olusturulmasi          
	Mesajdizisi[10]=1;
	Mesajdizisi[11]=1;
	...
	Mesajdizisi[26]=-1;
	Mesajdizisi[27]=-1;  
    Mesajdizisi[28]=-1;   // 0 ve 1 ile kodlanmis dizinin olusturulmasi
	Mesajdizisi[29]=-1;
	...
	j--;
	i=i/2;
	Toplam=Toplam+bitsayisi;
	Toplamsikistirilmadan=Toplamsikistirilmadan+8;
	bitsayisi=0;
...
//	 printf("%c\n",cozulenmetin[s-1]);  //Analiz için yazdirma
	...
	printf("\n");
	   ...
	   verim=(float(float(Toplam))/(float (Toplamsikistirilmadan)))*100 ;
	    printf("\nVerim(Yuzde):%f\n",verim);
